...
function tampilkanDaftarBuku() {
    ...
    daftarBuku.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            ...
            <button class="py-2 px-4 bg-violet-700 cursor-pointer rounded hover:bg-red-500 text-white" onclick="tambahKeFavorit(${index})">Tambah ke Favorit</button>
            <button class="py-2 px-4 bg-red-200 cursor-pointer rounded hover:bg-red-500" onclick="hapusDariDaftarBuku(${index})">Hapus</button>
        `;
...
function tampilkanBukuFavorit() {
    ...
    bukuFavorit.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            <p>${buku.tampilkanInfo()}</p>
            <button class="py-2 px-4 bg-red-200 cursor-pointer rounded hover:bg-red-500 " onclick="hapusDariFavorit(${index})">Hapus</button>
        `;
